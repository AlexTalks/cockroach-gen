...
type InputSyncSpec struct {
	...
	// made.
	EnforceHomeRegionStreamExclusiveUpperBound uint32 `protobuf:"varint,5,opt,name=enforce_home_region_stream_exclusive_upper_bound,json=enforceHomeRegionStreamExclusiveUpperBound" json:"enforce_home_region_stream_exclusive_upper_bound"`
	...
	EnforceHomeRegionError *Error `protobuf:"bytes,6,opt,name=enforce_home_region_error,json=enforceHomeRegionError" json:"enforce_home_region_error,omitempty"`
}
...
type OutputRouterSpec_RangeRouterSpec_ColumnEncoding struct {
	...
	Encoding catenumpb.DatumEncoding `protobuf:"varint,2,opt,name=encoding,enum=cockroach.sql.sqlbase.DatumEncoding" json:"encoding"`
}
...
type DatumInfo struct {
	Encoding catenumpb.DatumEncoding `protobuf:"varint,1,opt,name=encoding,enum=cockroach.sql.sqlbase.DatumEncoding" json:"encoding"`
...
type ProducerMessage struct {
	...
	Encoding []catenumpb.DatumEncoding `protobuf:"varint,4,rep,name=encoding,enum=cockroach.sql.sqlbase.DatumEncoding" json:"encoding,omitempty"`
}
...
type ChangefeedMeta struct {
	...
	Checkpoint []ChangefeedMeta_FrontierSpan `protobuf:"bytes,1,rep,name=checkpoint" json:"checkpoint"`
	...
	DrainInfo *ChangefeedMeta_DrainInfo `protobuf:"bytes,2,opt,name=drain_info,json=drainInfo" json:"drain_info,omitempty"`
	...
	Heartbeat bool `protobuf:"varint,3,opt,name=heartbeat" json:"heartbeat"`
}

func (m *ChangefeedMeta) Reset()         { *m = ChangefeedMeta{} }
func (m *ChangefeedMeta) String() string { return proto.CompactTextString(m) }
func (*ChangefeedMeta) ProtoMessage()    {}
func (*ChangefeedMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_88f01b948ed44512, []int{10}
}
func (m *ChangefeedMeta) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ChangefeedMeta) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *ChangefeedMeta) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ChangefeedMeta.Merge(m, src)
}
func (m *ChangefeedMeta) XXX_Size() int {
	return m.Size()
}
func (m *ChangefeedMeta) XXX_DiscardUnknown() {
	xxx_messageInfo_ChangefeedMeta.DiscardUnknown(m)
}

var xxx_messageInfo_ChangefeedMeta proto.InternalMessageInfo

type ChangefeedMeta_FrontierSpan struct {
...
func (m *ChangefeedMeta_FrontierSpan) Reset()         { *m = ChangefeedMeta_FrontierSpan{} }
func (m *ChangefeedMeta_FrontierSpan) String() string { return proto.CompactTextString(m) }
func (*ChangefeedMeta_FrontierSpan) ProtoMessage()    {}
func (*ChangefeedMeta_FrontierSpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_88f01b948ed44512, []int{10, 0}
}
func (m *ChangefeedMeta_FrontierSpan) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ChangefeedMeta_FrontierSpan) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *ChangefeedMeta_FrontierSpan) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ChangefeedMeta_FrontierSpan.Merge(m, src)
}
func (m *ChangefeedMeta_FrontierSpan) XXX_Size() int {
	return m.Size()
}
func (m *ChangefeedMeta_FrontierSpan) XXX_DiscardUnknown() {
	xxx_messageInfo_ChangefeedMeta_FrontierSpan.DiscardUnknown(m)
}

var xxx_messageInfo_ChangefeedMeta_FrontierSpan proto.InternalMessageInfo

type ChangefeedMeta_DrainInfo struct {
...
func (m *ChangefeedMeta_DrainInfo) Reset()         { *m = ChangefeedMeta_DrainInfo{} }
func (m *ChangefeedMeta_DrainInfo) String() string { return proto.CompactTextString(m) }
func (*ChangefeedMeta_DrainInfo) ProtoMessage()    {}
func (*ChangefeedMeta_DrainInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_88f01b948ed44512, []int{10, 1}
}
func (m *ChangefeedMeta_DrainInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ChangefeedMeta_DrainInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *ChangefeedMeta_DrainInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ChangefeedMeta_DrainInfo.Merge(m, src)
}
func (m *ChangefeedMeta_DrainInfo) XXX_Size() int {
	return m.Size()
}
func (m *ChangefeedMeta_DrainInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_ChangefeedMeta_DrainInfo.DiscardUnknown(m)
}

var xxx_messageInfo_ChangefeedMeta_DrainInfo proto.InternalMessageInfo
...
type RemoteProducerMetadata struct {
	...
	//	*RemoteProducerMetadata_Changefeed
...
type RemoteProducerMetadata_Changefeed struct {
	Changefeed *ChangefeedMeta `protobuf:"bytes,11,opt,name=changefeed,oneof" json:"changefeed,omitempty"`
}
type RemoteProducerMetadata_TracingAggregatorEvents struct {
	TracingAggregatorEvents *TracingAggregatorEvents `protobuf:"bytes,12,opt,name=tracing_aggregator_events,json=tracingAggregatorEvents,oneof" json:"tracing_aggregator_events,omitempty"`
}
...
func (*RemoteProducerMetadata_Changefeed) isRemoteProducerMetadata_Value()              {}
func (*RemoteProducerMetadata_TracingAggregatorEvents) isRemoteProducerMetadata_Value() {}
...
func (m *RemoteProducerMetadata) GetChangefeed() *ChangefeedMeta {
	if x, ok := m.GetValue().(*RemoteProducerMetadata_Changefeed); ok {
		return x.Changefeed
	}
	return nil
}

func (m *RemoteProducerMetadata) GetTracingAggregatorEvents() *TracingAggregatorEvents {
	if x, ok := m.GetValue().(*RemoteProducerMetadata_TracingAggregatorEvents); ok {
		return x.TracingAggregatorEvents
	}
	return nil
}
...
func (*RemoteProducerMetadata) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*RemoteProducerMetadata_Changefeed)(nil),
		(*RemoteProducerMetadata_TracingAggregatorEvents)(nil),
	}
}
...
func (*RemoteProducerMetadata_RangeInfos) Descriptor() ([]byte, []int) {
	return fileDescriptor_88f01b948ed44512, []int{11, 0}
}
...
func (*RemoteProducerMetadata_TraceData) Descriptor() ([]byte, []int) {
	return fileDescriptor_88f01b948ed44512, []int{11, 1}
}
...
func (*RemoteProducerMetadata_RowNum) Descriptor() ([]byte, []int) {
	return fileDescriptor_88f01b948ed44512, []int{11, 2}
}
...
func (*RemoteProducerMetadata_SamplerProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_88f01b948ed44512, []int{11, 3}
}
...
type RemoteProducerMetadata_BulkProcessorProgress struct {
	...
	BulkSummary      kvpb.BulkOpSummary `protobuf:"bytes,5,opt,name=bulk_summary,json=bulkSummary" json:"bulk_summary"`
	...
	NodeID github_com_cockroachdb_cockroach_pkg_base.SQLInstanceID `protobuf:"varint,7,opt,name=node_id,json=nodeId,casttype=github.com/cockroachdb/cockroach/pkg/base.SQLInstanceID" json:"node_id"`
	// FlowID is the unique identifier of the physical plan shared by all remote
	// flows.
	FlowID FlowID `protobuf:"bytes,8,opt,name=flow_id,json=flowId,customtype=FlowID" json:"flow_id"`
}
...
func (*RemoteProducerMetadata_BulkProcessorProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_88f01b948ed44512, []int{11, 4}
}
...
func (*RemoteProducerMetadata_Metrics) Descriptor() ([]byte, []int) {
	return fileDescriptor_88f01b948ed44512, []int{11, 5}
}
...
func (*DistSQLDrainingInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_88f01b948ed44512, []int{13}
}
...
type TracingAggregatorEvents struct {
	// SQLInstanceID is the node from which the aggregator event is being pushed
	// to the coordinator of the job.
	SQLInstanceID github_com_cockroachdb_cockroach_pkg_base.SQLInstanceID `protobuf:"varint,1,opt,name=sql_instance_id,json=sqlInstanceId,casttype=github.com/cockroachdb/cockroach/pkg/base.SQLInstanceID" json:"sql_instance_id"`
	// FlowID is the unique identifier of the physical plan shared by all remote
	// flows.
	FlowID FlowID            `protobuf:"bytes,2,opt,name=flow_id,json=flowId,customtype=FlowID" json:"flow_id"`
	Events map[string][]byte `protobuf:"bytes,3,rep,name=events" json:"events,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}

func (m *TracingAggregatorEvents) Reset()         { *m = TracingAggregatorEvents{} }
func (m *TracingAggregatorEvents) String() string { return proto.CompactTextString(m) }
func (*TracingAggregatorEvents) ProtoMessage()    {}
func (*TracingAggregatorEvents) Descriptor() ([]byte, []int) {
	return fileDescriptor_88f01b948ed44512, []int{14}
}
func (m *TracingAggregatorEvents) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TracingAggregatorEvents) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *TracingAggregatorEvents) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TracingAggregatorEvents.Merge(m, src)
}
func (m *TracingAggregatorEvents) XXX_Size() int {
	return m.Size()
}
func (m *TracingAggregatorEvents) XXX_DiscardUnknown() {
	xxx_messageInfo_TracingAggregatorEvents.DiscardUnknown(m)
}

var xxx_messageInfo_TracingAggregatorEvents proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*ChangefeedMeta)(nil), "cockroach.sql.distsqlrun.ChangefeedMeta")
	proto.RegisterType((*ChangefeedMeta_FrontierSpan)(nil), "cockroach.sql.distsqlrun.ChangefeedMeta.FrontierSpan")
	proto.RegisterType((*ChangefeedMeta_DrainInfo)(nil), "cockroach.sql.distsqlrun.ChangefeedMeta.DrainInfo")
	...
	proto.RegisterType((*TracingAggregatorEvents)(nil), "cockroach.sql.distsqlrun.TracingAggregatorEvents")
	proto.RegisterMapType((map[string][]byte)(nil), "cockroach.sql.distsqlrun.TracingAggregatorEvents.EventsEntry")
}
...
var fileDescriptor_88f01b948ed44512 = []byte{
	...
	,
}
...
func (m *InputSyncSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.EnforceHomeRegionError != nil {
		{
			size, err := m.EnforceHomeRegionError.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	i = encodeVarintData(dAtA, i, uint64(m.EnforceHomeRegionStreamExclusiveUpperBound))
	i--
	dAtA[i] = 0x28
...
func (m *ProducerMessage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Encoding) > 0 {
		for iNdEx := len(m.Encoding) - 1; iNdEx >= 0; iNdEx-- {
			i = encodeVarintData(dAtA, i, uint64(m.Encoding[iNdEx]))
			i--
			dAtA[i] = 0x20
		}
	}
...
func (m *ChangefeedMeta) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ChangefeedMeta) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ChangefeedMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.DrainInfo != nil {
		{
			size, err := m.DrainInfo.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ChangefeedMeta_FrontierSpan) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ChangefeedMeta_FrontierSpan) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ChangefeedMeta_FrontierSpan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ChangefeedMeta_DrainInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ChangefeedMeta_DrainInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ChangefeedMeta_DrainInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RemoteProducerMetadata_Changefeed) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RemoteProducerMetadata_Changefeed) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Changefeed != nil {
		{
...
func (m *RemoteProducerMetadata_TracingAggregatorEvents) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RemoteProducerMetadata_TracingAggregatorEvents) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.TracingAggregatorEvents != nil {
		{
			size, err := m.TracingAggregatorEvents.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RemoteProducerMetadata_BulkProcessorProgress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x38
	if len(m.CompletedSpanIdx) > 0 {
		for iNdEx := len(m.CompletedSpanIdx) - 1; iNdEx >= 0; iNdEx-- {
			i = encodeVarintData(dAtA, i, uint64(m.CompletedSpanIdx[iNdEx]))
			i--
			dAtA[i] = 0x30
		}
	}
	{
		size, err := m.BulkSummary.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *RemoteProducerMetadata_Metrics) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintData(dAtA, i, uint64(m.RowsWritten))
	i--
	dAtA[i] = 0x18
...
func (m *TracingAggregatorEvents) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TracingAggregatorEvents) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TracingAggregatorEvents) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Events) > 0 {
		...
		for iNdEx := len(keysForEvents) - 1; iNdEx >= 0; iNdEx-- {
			v := m.Events[string(keysForEvents[iNdEx])]
			baseI := i
			if v != nil {
				i -= len(v)
				copy(dAtA[i:], v)
			...
			i -= len(keysForEvents[iNdEx])
			copy(dAtA[i:], keysForEvents[iNdEx])
			i = encodeVarintData(dAtA, i, uint64(len(keysForEvents[iNdEx])))
			i--
			dAtA[i] = 0xa
			i = encodeVarintData(dAtA, i, uint64(baseI-i))
			i--
	...
	i--
	dAtA[i] = 0x12
	i = encodeVarintData(dAtA, i, uint64(m.SQLInstanceID))
	i--
	dAtA[i] = 0x8
	return len(dAtA) - i, nil
}
...
func (m *InputSyncSpec) Size() (n int) {
	...
	n += 1 + sovData(uint64(m.EnforceHomeRegionStreamExclusiveUpperBound))
	if m.EnforceHomeRegionError != nil {
		l = m.EnforceHomeRegionError.Size()
		n += 1 + l + sovData(uint64(l))
	}
	return n
}
...
func (m *ChangefeedMeta) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ChangefeedMeta_FrontierSpan) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ChangefeedMeta_DrainInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RemoteProducerMetadata_Changefeed) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RemoteProducerMetadata_TracingAggregatorEvents) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.TracingAggregatorEvents != nil {
		l = m.TracingAggregatorEvents.Size()
		n += 1 + l + sovData(uint64(l))
	}
	return n
}
...
func (m *RemoteProducerMetadata_BulkProcessorProgress) Size() (n int) {
	...
	n += 1 + l + sovData(uint64(l))
	l = m.BulkSummary.Size()
	n += 1 + l + sovData(uint64(l))
	if len(m.CompletedSpanIdx) > 0 {
		for _, e := range m.CompletedSpanIdx {
			n += 1 + sovData(uint64(e))
		}
	}
	n += 1 + sovData(uint64(m.NodeID))
...
func (m *RemoteProducerMetadata_Metrics) Size() (n int) {
	...
	n += 1 + sovData(uint64(m.RowsWritten))
	return n
}
...
func (m *TracingAggregatorEvents) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sovData(uint64(m.SQLInstanceID))
	l = m.FlowID.Size()
	n += 1 + l + sovData(uint64(l))
	if len(m.Events) > 0 {
		for k, v := range m.Events {
			...
			l = 0
			if v != nil {
				l = 1 + len(v) + sovData(uint64(len(v)))
			}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TargetNodeID |= github_com_cockroachdb_cockroach_pkg_base.SQLInstanceID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OriginNodeID |= github_com_cockroachdb_cockroach_pkg_base.SQLInstanceID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *InputSyncSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnforceHomeRegionStreamExclusiveUpperBound", wireType)
			}
			m.EnforceHomeRegionStreamExclusiveUpperBound = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowData
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EnforceHomeRegionStreamExclusiveUpperBound |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnforceHomeRegionError", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.EnforceHomeRegionError == nil {
				m.EnforceHomeRegionError = &Error{}
			}
			if err := m.EnforceHomeRegionError.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Encoding |= catenumpb.DatumEncoding(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 4:
			if wireType == 0 {
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= catenumpb.DatumEncoding(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				m.Encoding = append(m.Encoding, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				var elementCount int
				if elementCount != 0 && len(m.Encoding) == 0 {
					m.Encoding = make([]catenumpb.DatumEncoding, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v catenumpb.DatumEncoding
					for shift := uint(0); ; shift += 7 {
...
func (m *ChangefeedMeta) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ChangefeedMeta: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ChangefeedMeta: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Checkpoint = append(m.Checkpoint, ChangefeedMeta_FrontierSpan{})
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DrainInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DrainInfo == nil {
				m.DrainInfo = &ChangefeedMeta_DrainInfo{}
			}
			if err := m.DrainInfo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
...
func (m *ChangefeedMeta_FrontierSpan) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FrontierSpan: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FrontierSpan: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ChangefeedMeta_DrainInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DrainInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DrainInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *RemoteProducerMetadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			m.Value = &RemoteProducerMetadata_Changefeed{v}
			iNdEx = postIndex
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TracingAggregatorEvents", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &TracingAggregatorEvents{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &RemoteProducerMetadata_TracingAggregatorEvents{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipData(dAtA[iNdEx:])
...
func (m *RemoteProducerMetadata_BulkProcessorProgress) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BulkSummary", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.BulkSummary.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
			if wireType == 0 {
				...
				m.CompletedSpanIdx = append(m.CompletedSpanIdx, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.CompletedSpanIdx) == 0 {
					m.CompletedSpanIdx = make([]int32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field CompletedSpanIdx", wireType)
			}
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NodeID", wireType)
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NodeID |= github_com_cockroachdb_cockroach_pkg_base.SQLInstanceID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *TracingAggregatorEvents) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TracingAggregatorEvents: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TracingAggregatorEvents: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
