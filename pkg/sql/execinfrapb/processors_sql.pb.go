...
const (
	...
	AggregatorSpec_ARRAY_CAT_AGG                   AggregatorSpec_Func = 61
	AggregatorSpec_MERGE_STATS_METADATA            AggregatorSpec_Func = 62
	AggregatorSpec_MERGE_STATEMENT_STATS           AggregatorSpec_Func = 63
	AggregatorSpec_MERGE_TRANSACTION_STATS         AggregatorSpec_Func = 64
	AggregatorSpec_MERGE_AGGREGATED_STMT_METADATA  AggregatorSpec_Func = 65
)
...
var AggregatorSpec_Func_name = map[int32]string{
	...
	60: "FINAL_SQRDIFF",
	61: "ARRAY_CAT_AGG",
	62: "MERGE_STATS_METADATA",
	63: "MERGE_STATEMENT_STATS",
	64: "MERGE_TRANSACTION_STATS",
	65: "MERGE_AGGREGATED_STMT_METADATA",
}
...
func (AggregatorSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{12, 1}
}
...
func (WindowerSpec_WindowFunc) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{14, 0}
}
...
func (WindowerSpec_Frame_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{14, 1, 0}
}
...
func (WindowerSpec_Frame_BoundType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{14, 1, 1}
}
...
func (WindowerSpec_Frame_Exclusion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{14, 1, 2}
}
...
type TableReaderSpec struct {
	FetchSpec fetchpb.IndexFetchSpec `protobuf:"bytes,20,opt,name=fetch_spec,json=fetchSpec" json:"fetch_spec"`
	...
	// this spec.
	TableDescriptorModificationTime hlc.Timestamp  `protobuf:"bytes,21,opt,name=table_descriptor_modification_time,json=tableDescriptorModificationTime" json:"table_descriptor_modification_time"`
	...
	LockingDurability descpb.ScanLockingDurability `protobuf:"varint,23,opt,name=locking_durability,json=lockingDurability,enum=cockroach.sql.sqlbase.ScanLockingDurability" json:"locking_durability"`
	...
	IgnoreMisplannedRanges bool `protobuf:"varint,22,opt,name=ignore_misplanned_ranges,json=ignoreMisplannedRanges" json:"ignore_misplanned_ranges"`
}
...
type JoinReaderSpec struct {
	FetchSpec fetchpb.IndexFetchSpec `protobuf:"bytes,19,opt,name=fetch_spec,json=fetchSpec" json:"fetch_spec"`
	...
	SplitFamilyIDs []github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.FamilyID `protobuf:"varint,20,rep,name=split_family_ids,json=splitFamilyIds,casttype=github.com/cockroachdb/cockroach/pkg/sql/catalog/descpb.FamilyID" json:"split_family_ids,omitempty"`
	...
	// Indicates the row-level locking durability to be used by the scan.
	LockingDurability descpb.ScanLockingDurability `protobuf:"varint,24,opt,name=locking_durability,json=lockingDurability,enum=cockroach.sql.sqlbase.ScanLockingDurability" json:"locking_durability"`
	...
	// Not used if there is a limit set in the PostProcessSpec of this processor
	// (that value will be used for sizing batches instead).
	LimitHint int64 `protobuf:"varint,21,opt,name=limit_hint,json=limitHint" json:"limit_hint"`
	...
	RemoteOnlyLookups bool `protobuf:"varint,23,opt,name=remote_only_lookups,json=remoteOnlyLookups" json:"remote_only_lookups"`
}
...
type ZigzagJoinerSpec struct {
	Sides []ZigzagJoinerSpec_Side `protobuf:"bytes,7,rep,name=sides" json:"sides"`
...
type ZigzagJoinerSpec_Side struct {
	FetchSpec fetchpb.IndexFetchSpec `protobuf:"bytes,1,opt,name=fetch_spec,json=fetchSpec" json:"fetch_spec"`
	...
	EqColumns Columns `protobuf:"bytes,2,opt,name=eq_columns,json=eqColumns" json:"eq_columns"`
	// Fixed values, corresponding to a prefix of the index key columns.
	FixedValues ValuesCoreSpec `protobuf:"bytes,3,opt,name=fixed_values,json=fixedValues" json:"fixed_values"`
	// Indicates the row-level locking strength to be used by the scan. If set to
	// FOR_NONE, no row-level locking should be performed.
	LockingStrength descpb.ScanLockingStrength `protobuf:"varint,4,opt,name=locking_strength,json=lockingStrength,enum=cockroach.sql.sqlbase.ScanLockingStrength" json:"locking_strength"`
	// Indicates the policy to be used by the scan for handling conflicting locks
	// held by other active transactions when attempting to lock rows. Always set
	// to BLOCK when locking_strength is FOR_NONE.
	LockingWaitPolicy descpb.ScanLockingWaitPolicy `protobuf:"varint,5,opt,name=locking_wait_policy,json=lockingWaitPolicy,enum=cockroach.sql.sqlbase.ScanLockingWaitPolicy" json:"locking_wait_policy"`
	// Indicates the row-level locking durability to be used by the scan.
	LockingDurability descpb.ScanLockingDurability `protobuf:"varint,8,opt,name=locking_durability,json=lockingDurability,enum=cockroach.sql.sqlbase.ScanLockingDurability" json:"locking_durability"`
}

func (m *ZigzagJoinerSpec_Side) Reset()         { *m = ZigzagJoinerSpec_Side{} }
func (m *ZigzagJoinerSpec_Side) String() string { return proto.CompactTextString(m) }
func (*ZigzagJoinerSpec_Side) ProtoMessage()    {}
func (*ZigzagJoinerSpec_Side) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{7, 0}
}
func (m *ZigzagJoinerSpec_Side) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ZigzagJoinerSpec_Side) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *ZigzagJoinerSpec_Side) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ZigzagJoinerSpec_Side.Merge(m, src)
}
func (m *ZigzagJoinerSpec_Side) XXX_Size() int {
	return m.Size()
}
func (m *ZigzagJoinerSpec_Side) XXX_DiscardUnknown() {
	xxx_messageInfo_ZigzagJoinerSpec_Side.DiscardUnknown(m)
}

var xxx_messageInfo_ZigzagJoinerSpec_Side proto.InternalMessageInfo
...
type InvertedJoinerSpec struct {
	FetchSpec fetchpb.IndexFetchSpec `protobuf:"bytes,10,opt,name=fetch_spec,json=fetchSpec" json:"fetch_spec"`
	// InvertedColumnOriginalType is the type of the table column that is being
	// indexed (e.g. JSON or Geometry).
	InvertedColumnOriginalType *types.T `protobuf:"bytes,11,opt,name=inverted_column_original_type,json=invertedColumnOriginalType" json:"inverted_column_original_type,omitempty"`
	...
	// Indicates the row-level locking strength to be used by the scan. If set to
	// FOR_NONE, no row-level locking should be performed.
	LockingStrength descpb.ScanLockingStrength `protobuf:"varint,12,opt,name=locking_strength,json=lockingStrength,enum=cockroach.sql.sqlbase.ScanLockingStrength" json:"locking_strength"`
	// Indicates the policy to be used by the scan for handling conflicting locks
	// held by other active transactions when attempting to lock rows. Always set
	// to BLOCK when locking_strength is FOR_NONE.
	LockingWaitPolicy descpb.ScanLockingWaitPolicy `protobuf:"varint,13,opt,name=locking_wait_policy,json=lockingWaitPolicy,enum=cockroach.sql.sqlbase.ScanLockingWaitPolicy" json:"locking_wait_policy"`
	// Indicates the row-level locking durability to be used by the scan.
	LockingDurability descpb.ScanLockingDurability `protobuf:"varint,14,opt,name=locking_durability,json=lockingDurability,enum=cockroach.sql.sqlbase.ScanLockingDurability" json:"locking_durability"`
}
...
func (*InvertedFiltererSpec_PreFiltererSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{11, 0}
}
...
type ProjectSetSpec struct {
	...
	GeneratedColumnLabels []string `protobuf:"bytes,4,rep,name=generated_column_labels,json=generatedColumnLabels" json:"generated_column_labels,omitempty"`
}
...
func (*WindowerSpec_Frame) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{14, 1}
}
...
func (*WindowerSpec_WindowFn) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{14, 2}
}
...
type HashGroupJoinerSpec struct {
	HashJoinerSpec HashJoinerSpec `protobuf:"bytes,1,opt,name=hash_joiner_spec,json=hashJoinerSpec" json:"hash_joiner_spec"`
	...
	// by the aggregator.
	JoinOutputColumns []uint32       `protobuf:"varint,2,rep,packed,name=join_output_columns,json=joinOutputColumns" json:"join_output_columns,omitempty"`
	AggregatorSpec    AggregatorSpec `protobuf:"bytes,3,opt,name=aggregator_spec,json=aggregatorSpec" json:"aggregator_spec"`
}

func (m *HashGroupJoinerSpec) Reset()         { *m = HashGroupJoinerSpec{} }
func (m *HashGroupJoinerSpec) String() string { return proto.CompactTextString(m) }
func (*HashGroupJoinerSpec) ProtoMessage()    {}
func (*HashGroupJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{15}
}
func (m *HashGroupJoinerSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HashGroupJoinerSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *HashGroupJoinerSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HashGroupJoinerSpec.Merge(m, src)
}
func (m *HashGroupJoinerSpec) XXX_Size() int {
	return m.Size()
}
func (m *HashGroupJoinerSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_HashGroupJoinerSpec.DiscardUnknown(m)
}

var xxx_messageInfo_HashGroupJoinerSpec proto.InternalMessageInfo
...
type InsertSpec struct {
	...
	ColumnIDs []github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.ColumnID `protobuf:"varint,2,rep,name=column_ids,json=columnIds,casttype=github.com/cockroachdb/cockroach/pkg/sql/catalog/descpb.ColumnID" json:"column_ids,omitempty"`
	// The serialized bytes from intsets.Fast.Encode.
	CheckOrds []byte `protobuf:"bytes,3,opt,name=check_ords,json=checkOrds" json:"check_ords,omitempty"`
	// Whether the insert should be autocommitted.
	AutoCommit bool `protobuf:"varint,4,opt,name=auto_commit,json=autoCommit" json:"auto_commit"`
}

func (m *InsertSpec) Reset()         { *m = InsertSpec{} }
func (m *InsertSpec) String() string { return proto.CompactTextString(m) }
func (*InsertSpec) ProtoMessage()    {}
func (*InsertSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{16}
}
func (m *InsertSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *InsertSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *InsertSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_InsertSpec.Merge(m, src)
}
func (m *InsertSpec) XXX_Size() int {
	return m.Size()
}
func (m *InsertSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_InsertSpec.DiscardUnknown(m)
}

var xxx_messageInfo_InsertSpec proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*ZigzagJoinerSpec_Side)(nil), "cockroach.sql.distsqlrun.ZigzagJoinerSpec.Side")
	...
	proto.RegisterType((*HashGroupJoinerSpec)(nil), "cockroach.sql.distsqlrun.HashGroupJoinerSpec")
	proto.RegisterType((*InsertSpec)(nil), "cockroach.sql.distsqlrun.InsertSpec")
}
...
var fileDescriptor_90493aed97b6d28f = []byte{
	...
	,
}
...
func (m *TableReaderSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintProcessorsSql(dAtA, i, uint64(m.LockingDurability))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0xb8
	i--
	if m.IgnoreMisplannedRanges {
		dAtA[i] = 1
	} else {
		dAtA[i] = 0
	}
	...
	dAtA[i] = 0xb0
	{
		size, err := m.TableDescriptorModificationTime.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	i = encodeVarintProcessorsSql(dAtA, i, uint64(m.BatchBytesLimit))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0x88
...
func (m *JoinReaderSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0xa8
	if len(m.SplitFamilyIDs) > 0 {
		for iNdEx := len(m.SplitFamilyIDs) - 1; iNdEx >= 0; iNdEx-- {
			i = encodeVarintProcessorsSql(dAtA, i, uint64(m.SplitFamilyIDs[iNdEx]))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0xa0
	...
	i--
	dAtA[i] = 0x9a
	i = encodeVarintProcessorsSql(dAtA, i, uint64(m.LookupBatchBytesLimit))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0x90
...
func (m *SorterSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintProcessorsSql(dAtA, i, uint64(m.Limit))
	i--
	dAtA[i] = 0x18
...
func (m *ZigzagJoinerSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Sides) > 0 {
		for iNdEx := len(m.Sides) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Sides[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ZigzagJoinerSpec_Side) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ZigzagJoinerSpec_Side) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ZigzagJoinerSpec_Side) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	dAtA[i] = 0x20
	{
		size, err := m.FixedValues.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	dAtA[i] = 0x1a
	{
		size, err := m.EqColumns.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *InvertedJoinerSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x60
	if m.InvertedColumnOriginalType != nil {
		{
			size, err := m.InvertedColumnOriginalType.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *AggregatorSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OrderedGroupCols) > 0 {
		dAtA36 := make([]byte, len(m.OrderedGroupCols)*10)
		var j35 int
		...
		i = encodeVarintProcessorsSql(dAtA, i, uint64(j35))
		i--
		dAtA[i] = 0x22
	}
	...
	if len(m.GroupCols) > 0 {
		dAtA38 := make([]byte, len(m.GroupCols)*10)
		var j37 int
		...
		i = encodeVarintProcessorsSql(dAtA, i, uint64(j37))
		i--
		dAtA[i] = 0x12
	}
	return len(dAtA) - i, nil
...
func (m *ProjectSetSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.GeneratedColumnLabels) > 0 {
		for iNdEx := len(m.GeneratedColumnLabels) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.GeneratedColumnLabels[iNdEx])
			copy(dAtA[i:], m.GeneratedColumnLabels[iNdEx])
			i = encodeVarintProcessorsSql(dAtA, i, uint64(len(m.GeneratedColumnLabels[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
...
func (m *HashGroupJoinerSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HashGroupJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HashGroupJoinerSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	{
		size, err := m.AggregatorSpec.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	i--
	dAtA[i] = 0x1a
	if len(m.JoinOutputColumns) > 0 {
		dAtA48 := make([]byte, len(m.JoinOutputColumns)*10)
		var j47 int
		for _, num := range m.JoinOutputColumns {
			for num >= 1<<7 {
		...
		i = encodeVarintProcessorsSql(dAtA, i, uint64(j47))
		i--
		dAtA[i] = 0x12
	}
	{
		size, err := m.HashJoinerSpec.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *InsertSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *InsertSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *InsertSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.CheckOrds != nil {
		i -= len(m.CheckOrds)
		copy(dAtA[i:], m.CheckOrds)
		i = encodeVarintProcessorsSql(dAtA, i, uint64(len(m.CheckOrds)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.ColumnIDs) > 0 {
		for iNdEx := len(m.ColumnIDs) - 1; iNdEx >= 0; iNdEx-- {
			i = encodeVarintProcessorsSql(dAtA, i, uint64(m.ColumnIDs[iNdEx]))
			i--
			dAtA[i] = 0x10
		}
	}
...
func (m *TableReaderSpec) Size() (n int) {
	...
	n += 2
	n += 2 + sovProcessorsSql(uint64(m.BatchBytesLimit))
	if len(m.Spans) > 0 {
	...
	l = m.FetchSpec.Size()
	n += 2 + l + sovProcessorsSql(uint64(l))
	l = m.TableDescriptorModificationTime.Size()
	n += 2 + l + sovProcessorsSql(uint64(l))
	n += 3
	n += 2 + sovProcessorsSql(uint64(m.LockingDurability))
	return n
}
...
func (m *JoinReaderSpec) Size() (n int) {
	...
	n += 2 + l + sovProcessorsSql(uint64(l))
	n += 2 + sovProcessorsSql(uint64(m.LookupBatchBytesLimit))
	l = m.FetchSpec.Size()
	n += 2 + l + sovProcessorsSql(uint64(l))
	if len(m.SplitFamilyIDs) > 0 {
		for _, e := range m.SplitFamilyIDs {
			n += 2 + sovProcessorsSql(uint64(e))
		}
	}
	n += 2 + sovProcessorsSql(uint64(m.LimitHint))
	n += 3
	n += 3
	n += 2 + sovProcessorsSql(uint64(m.LockingDurability))
	return n
...
func (m *SorterSpec) Size() (n int) {
	...
	n += 1 + sovProcessorsSql(uint64(m.Limit))
	return n
}
...
func (m *ZigzagJoinerSpec_Side) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	l = m.EqColumns.Size()
	n += 1 + l + sovProcessorsSql(uint64(l))
	l = m.FixedValues.Size()
	n += 1 + l + sovProcessorsSql(uint64(l))
	n += 1 + sovProcessorsSql(uint64(m.LockingStrength))
	n += 1 + sovProcessorsSql(uint64(m.LockingWaitPolicy))
	n += 1 + sovProcessorsSql(uint64(m.LockingDurability))
	return n
}
...
func (m *InvertedJoinerSpec) Size() (n int) {
	...
	n += 1 + l + sovProcessorsSql(uint64(l))
	if m.InvertedColumnOriginalType != nil {
		l = m.InvertedColumnOriginalType.Size()
		n += 1 + l + sovProcessorsSql(uint64(l))
	}
	n += 1 + sovProcessorsSql(uint64(m.LockingStrength))
	n += 1 + sovProcessorsSql(uint64(m.LockingWaitPolicy))
...
func (m *ProjectSetSpec) Size() (n int) {
	...
	if len(m.GeneratedColumnLabels) > 0 {
		for _, s := range m.GeneratedColumnLabels {
			l = len(s)
			n += 1 + l + sovProcessorsSql(uint64(l))
		}
	}
...
func (m *HashGroupJoinerSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = m.HashJoinerSpec.Size()
	n += 1 + l + sovProcessorsSql(uint64(l))
	if len(m.JoinOutputColumns) > 0 {
		l = 0
		for _, e := range m.JoinOutputColumns {
			l += sovProcessorsSql(uint64(e))
		}
		n += 1 + sovProcessorsSql(uint64(l)) + l
	}
	l = m.AggregatorSpec.Size()
	n += 1 + l + sovProcessorsSql(uint64(l))
	return n
}

func (m *InsertSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TableReaderSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BatchBytesLimit", wireType)
			}
			m.BatchBytesLimit = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BatchBytesLimit |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 21:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TableDescriptorModificationTime", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.TableDescriptorModificationTime.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 22:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IgnoreMisplannedRanges", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IgnoreMisplannedRanges = bool(v != 0)
		case 23:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LockingDurability", wireType)
			}
			m.LockingDurability = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowProcessorsSql
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LockingDurability |= descpb.ScanLockingDurability(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *JoinReaderSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LookupBatchBytesLimit", wireType)
			}
			m.LookupBatchBytesLimit = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowProcessorsSql
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LookupBatchBytesLimit |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 20:
			if wireType == 0 {
				...
				m.SplitFamilyIDs = append(m.SplitFamilyIDs, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.SplitFamilyIDs) == 0 {
					m.SplitFamilyIDs = make([]github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.FamilyID, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v github_com_cockroachdb_cockroach_pkg_sql_catalog_descpb.FamilyID
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field SplitFamilyIDs", wireType)
			}
		case 21:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LimitHint", wireType)
		...
		case 22:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaintainLookupOrdering", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MaintainLookupOrdering = bool(v != 0)
		case 23:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RemoteOnlyLookups", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *ZigzagJoinerSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.Sides = append(m.Sides, ZigzagJoinerSpec_Side{})
			if err := m.Sides[len(m.Sides)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ZigzagJoinerSpec_Side) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 2:
			...
			if err := m.EqColumns.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			...
			if err := m.FixedValues.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
...
func (m *InvertedJoinerSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InvertedColumnOriginalType", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.InvertedColumnOriginalType == nil {
				m.InvertedColumnOriginalType = &types.T{}
			}
			if err := m.InvertedColumnOriginalType.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 12:
...
func (m *ProjectSetSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GeneratedColumnLabels", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.GeneratedColumnLabels = append(m.GeneratedColumnLabels, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProcessorsSql(dAtA[iNdEx:])
...
func (m *HashGroupJoinerSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HashGroupJoinerSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HashGroupJoinerSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HashJoinerSpec", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.HashJoinerSpec.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType == 0 {
				...
				m.JoinOutputColumns = append(m.JoinOutputColumns, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.JoinOutputColumns) == 0 {
					m.JoinOutputColumns = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field JoinOutputColumns", wireType)
			}
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AggregatorSpec", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.AggregatorSpec.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *InsertSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: InsertSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: InsertSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CheckOrds", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CheckOrds = append(m.CheckOrds[:0], dAtA[iNdEx:postIndex]...)
			if m.CheckOrds == nil {
				m.CheckOrds = []byte{}
			}
			iNdEx = postIndex
