...
const (
	...
	// execbuilder phase.
	FastPathUniqueChecksItemPrivateOp
	...
	MergeStatementStatsOp

	MergeStatsMetadataOp
...
const opNames = "unknownagg-distinctagg-filteraggregationsaggregations-itemalter-range-relocatealter-range-relocate-privatealter-table-relocatealter-table-relocate-privatealter-table-splitalter-table-split-privatealter-table-unsplitalter-table-unsplit-allandanti-joinanti-join-applyanyany-not-null-aggany-scalararrayarray-aggarray-cat-aggarray-flattenassignment-castavgb-box-coversb-box-intersectsbarrierbit-and-aggbit-or-aggbitandbitorbitxorbool-andbool-orcallcall-privatecancel-privatecancel-queriescancel-sessionscasecastcoalescecollatecolumn-accessconcatconcat-aggconstconst-aggconst-not-null-aggcontained-bycontainscontrol-jobscontrol-jobs-privatecontrol-schedulescontrol-schedules-privatecorrcountcount-rowscovar-popcovar-sampcreate-functioncreate-function-privatecreate-statisticscreate-statistics-privatecreate-tablecreate-table-privatecreate-viewcreate-view-privatecume-distdeletedense-rankdistinct-ondistributedivensure-distinct-onensure-upsert-distinct-oneqexceptexcept-allexistsexists-privateexplainexplain-privateexportexport-privatef-k-checksf-k-checks-itemf-k-checks-item-privatefake-relfake-rel-privatefalsefast-path-unique-checksfast-path-unique-checks-itemfast-path-unique-checks-item-privatefetch-textfetch-text-pathfetch-valfetch-val-pathfiltersfilters-itemfirst-aggfirst-valuefloor-divfull-joinfunctionfunction-privategegroup-bygrouping-privategti-likeif-errinindex-joinindex-join-privateindirectioninner-joininner-join-applyinsertintersectintersect-allinverted-filterinverted-filter-privateinverted-joininverted-join-privateisis-notis-tuple-not-nullis-tuple-nulljoin-privatejson-aggjson-all-existsjson-existsjson-object-aggjson-some-existsjsonb-aggjsonb-object-aggk-v-optionsk-v-options-iteml-shiftlaglast-valueleleadleft-joinleft-join-applylikelimitliteral-valueslocality-optimized-searchlocklock-privatelookup-joinlookup-join-privateltmaxmax1-rowmemo-cycle-test-relmerge-aggregated-stmt-metadatamerge-joinmerge-join-privatemerge-statement-statsmerge-stats-metadatamerge-transaction-statsminminusmodmultmutation-privatenenorm-cycle-test-relnotnot-i-likenot-innot-likenot-reg-i-matchnot-reg-matchnot-similar-tonth-valuentilenulloffsetopaque-d-d-lopaque-mutationopaque-relopaque-rel-privateorordinalityordinality-privateoverlapspercent-rankpercentile-contpercentile-discplaceholderplaceholder-scanpluspowprojectproject-setprojectionsprojections-itemr-shiftrangerankrecursive-c-t-erecursive-c-t-e-privatereg-i-matchreg-matchregression-avg-xregression-avg-yregression-countregression-interceptregression-r2regression-s-x-xregression-s-x-yregression-s-y-yregression-sloperight-joinrow-numbers-t-collects-t-extents-t-make-lines-t-unionscalar-group-byscalar-listscanscan-privateselectsemi-joinsemi-join-applysequence-selectsequence-select-privateset-privateshow-completionsshow-completions-privateshow-trace-for-sessionshow-trace-privatesimilar-tosortsqr-diffstd-devstd-dev-popstring-aggsubquerysubquery-privatesumsum-intt-s-matchestop-ktop-k-privatetruetupletxn-controltxn-control-privateu-d-f-callu-d-f-call-privateunary-cbrtunary-complementunary-minusunary-plusunary-sqrtunionunion-allunique-checksunique-checks-itemunique-checks-item-privateupdateupsertupsert-distinct-onvaluesvalues-privatevar-popvariablevariancewhenwindowwindow-from-offsetwindow-privatewindow-to-offsetwindowswindows-itemwindows-item-privatewithwith-privatewith-scanwith-scan-privatexor-aggzigzag-joinzigzag-join-privatezipzip-item"

var opNameIndexes = [...]uint32{0, 7, 19, 29, 41, 58, 78, 106, 126, 154, 171, 196, 215, 238, 241, 250, 265, 268, 284, 294, 299, 308, 321, 334, 349, 352, 364, 380, 387, 398, 408, 414, 419, 425, 433, 440, 444, 456, 470, 484, 499, 503, 507, 515, 522, 535, 541, 551, 556, 565, 583, 595, 603, 615, 635, 652, 677, 681, 686, 696, 705, 715, 730, 753, 770, 795, 807, 827, 838, 857, 866, 872, 882, 893, 903, 906, 924, 949, 951, 957, 967, 973, 987, 994, 1009, 1015, 1029, 1039, 1054, 1077, 1085, 1101, 1106, 1129, 1157, 1193, 1203, 1218, 1227, 1241, 1248, 1260, 1269, 1280, 1289, 1298, 1306, 1322, 1324, 1332, 1348, 1350, 1356, 1362, 1364, 1374, 1392, 1403, 1413, 1429, 1435, 1444, 1457, 1472, 1495, 1508, 1529, 1531, 1537, 1554, 1567, 1579, 1587, 1602, 1613, 1628, 1644, 1653, 1669, 1680, 1696, 1703, 1706, 1716, 1718, 1722, 1731, 1746, 1750, 1755, 1769, 1794, 1798, 1810, 1821, 1840, 1842, 1845, 1853, 1872, 1902, 1912, 1930, 1951, 1971, 1994, 1997, 2002, 2005, 2009, 2025, 2027, 2046, 2049, 2059, 2065, 2073, 2088, 2101, 2115, 2124, 2129, 2133, 2139, 2151, 2166, 2176, 2194, 2196, 2206, 2224, 2232, 2244, 2259, 2274, 2285, 2301, 2305, 2308, 2315, 2326, 2337, 2353, 2360, 2365, 2369, 2384, 2407, 2418, 2427, 2443, 2459, 2475, 2495, 2508, 2524, 2540, 2556, 2572, 2582, 2592, 2603, 2613, 2626, 2635, 2650, 2661, 2665, 2677, 2683, 2692, 2707, 2722, 2745, 2756, 2772, 2796, 2818, 2836, 2846, 2850, 2858, 2865, 2876, 2886, 2894, 2910, 2913, 2920, 2931, 2936, 2949, 2953, 2958, 2969, 2988, 2998, 3016, 3026, 3042, 3053, 3063, 3073, 3078, 3087, 3100, 3118, 3144, 3150, 3156, 3174, 3180, 3194, 3201, 3209, 3217, 3221, 3227, 3245, 3259, 3275, 3282, 3294, 3314, 3318, 3330, 3339, 3356, 3363, 3374, 3393, 3396, 3404}
...
func IsRelationalOp(e Expr) bool {
	...
	case AlterRangeRelocateOp, AlterTableRelocateOp, AlterTableSplitOp, AlterTableUnsplitOp,
		AlterTableUnsplitAllOp, AntiJoinOp, AntiJoinApplyOp, BarrierOp, CallOp,
		CancelQueriesOp, CancelSessionsOp, ControlJobsOp, ControlSchedulesOp, CreateFunctionOp,
		CreateStatisticsOp, CreateTableOp, CreateViewOp, DeleteOp, DistinctOnOp,
		...
		LiteralValuesOp, LocalityOptimizedSearchOp, LockOp, LookupJoinOp, Max1RowOp,
		MemoCycleTestRelOp, MergeJoinOp, NormCycleTestRelOp, OffsetOp, OpaqueDDLOp,
		OpaqueMutationOp, OpaqueRelOp, OrdinalityOp, PlaceholderScanOp, ProjectOp,
		ProjectSetOp, RecursiveCTEOp, RightJoinOp, ScalarGroupByOp, ScanOp,
		SelectOp, SemiJoinOp, SemiJoinApplyOp, SequenceSelectOp, ShowCompletionsOp,
		ShowTraceForSessionOp, TopKOp, UnionOp, UnionAllOp, UpdateOp,
		UpsertOp, UpsertDistinctOnOp, ValuesOp, WindowOp, WithOp,
		WithScanOp, ZigzagJoinOp:
		return true
	}
	return false
}
...
func IsMutationOp(e Expr) bool {
	...
	case AlterRangeRelocateOp, AlterTableRelocateOp, AlterTableSplitOp, AlterTableUnsplitOp,
		...
		InsertOp, LockOp, OpaqueDDLOp, OpaqueMutationOp, UpdateOp,
		UpsertOp:
		return true
	}
	return false
...
func IsPrivateOp(e Expr) bool {
	switch e.Op() {
	case AlterRangeRelocatePrivateOp, AlterTableRelocatePrivateOp, AlterTableSplitPrivateOp, CallPrivateOp,
		CancelPrivateOp, ControlJobsPrivateOp, ControlSchedulesPrivateOp, CreateFunctionPrivateOp, CreateStatisticsPrivateOp,
		CreateTablePrivateOp, CreateViewPrivateOp, ExistsPrivateOp, ExplainPrivateOp, ExportPrivateOp,
		FKChecksItemPrivateOp, FakeRelPrivateOp, FastPathUniqueChecksItemPrivateOp, FunctionPrivateOp, GroupingPrivateOp,
		IndexJoinPrivateOp, InvertedFilterPrivateOp, InvertedJoinPrivateOp, JoinPrivateOp, LockPrivateOp,
		LookupJoinPrivateOp, MergeJoinPrivateOp, MutationPrivateOp, OpaqueRelPrivateOp, OrdinalityPrivateOp,
		RecursiveCTEPrivateOp, ScanPrivateOp, SequenceSelectPrivateOp, SetPrivateOp, ShowCompletionsPrivateOp,
		ShowTracePrivateOp, SubqueryPrivateOp, TopKPrivateOp, TxnControlPrivateOp, UDFCallPrivateOp,
		UniqueChecksItemPrivateOp, ValuesPrivateOp, WindowPrivateOp, WindowsItemPrivateOp, WithPrivateOp,
		WithScanPrivateOp, ZigzagJoinPrivateOp:
		return true
	}
	return false
}
...
func IsScalarOp(e Expr) bool {
	...
	case AggDistinctOp, AggFilterOp, AggregationsOp, AggregationsItemOp,
		...
		ArrayAggOp, ArrayCatAggOp, ArrayFlattenOp, AssignmentCastOp, AvgOp,
		BBoxCoversOp, BBoxIntersectsOp, BitAndAggOp, BitOrAggOp, BitandOp,
		BitorOp, BitxorOp, BoolAndOp, BoolOrOp, CaseOp,
		CastOp, CoalesceOp, CollateOp, ColumnAccessOp, ConcatOp,
		ConcatAggOp, ConstOp, ConstAggOp, ConstNotNullAggOp, ContainedByOp,
		ContainsOp, CorrOp, CountOp, CountRowsOp, CovarPopOp,
		CovarSampOp, CumeDistOp, DenseRankOp, DivOp, EqOp,
		ExistsOp, FKChecksOp, FKChecksItemOp, FalseOp, FastPathUniqueChecksOp,
		FastPathUniqueChecksItemOp, FetchTextOp, FetchTextPathOp, FetchValOp, FetchValPathOp,
		FiltersOp, FiltersItemOp, FirstAggOp, FirstValueOp, FloorDivOp,
		FunctionOp, GeOp, GtOp, ILikeOp, IfErrOp,
		InOp, IndirectionOp, IsOp, IsNotOp, IsTupleNotNullOp,
		IsTupleNullOp, JsonAggOp, JsonAllExistsOp, JsonExistsOp, JsonObjectAggOp,
		JsonSomeExistsOp, JsonbAggOp, JsonbObjectAggOp, KVOptionsOp, KVOptionsItemOp,
		LShiftOp, LagOp, LastValueOp, LeOp, LeadOp,
		LikeOp, LtOp, MaxOp, MergeAggregatedStmtMetadataOp, MergeStatementStatsOp,
		MergeStatsMetadataOp, MergeTransactionStatsOp, MinOp, MinusOp, ModOp,
		...
		RegIMatchOp, RegMatchOp, RegressionAvgXOp, RegressionAvgYOp, RegressionCountOp,
		RegressionInterceptOp, RegressionR2Op, RegressionSXXOp, RegressionSXYOp, RegressionSYYOp,
		RegressionSlopeOp, RowNumberOp, STCollectOp, STExtentOp, STMakeLineOp,
		STUnionOp, ScalarListOp, SimilarToOp, SqrDiffOp, StdDevOp,
		StdDevPopOp, StringAggOp, SubqueryOp, SumOp, SumIntOp,
		TSMatchesOp, TrueOp, TupleOp, TxnControlOp, UDFCallOp,
		UnaryCbrtOp, UnaryComplementOp, UnaryMinusOp, UnaryPlusOp, UnarySqrtOp,
		UniqueChecksOp, UniqueChecksItemOp, VarPopOp, VariableOp, VarianceOp,
...
func IsListOp(e Expr) bool {
	switch e.Op() {
	case AggregationsOp, FKChecksOp, FastPathUniqueChecksOp, FiltersOp,
		KVOptionsOp, ProjectionsOp, ScalarListOp, UniqueChecksOp, WindowsOp,
		ZipOp:
		return true
	}
	return false
...
func IsListItemOp(e Expr) bool {
	switch e.Op() {
	case AggregationsItemOp, FKChecksItemOp, FastPathUniqueChecksItemOp, FiltersItemOp,
		KVOptionsItemOp, ProjectionsItemOp, UniqueChecksItemOp, WindowsItemOp, ZipItemOp:
		return true
	}
	return false
}
...
func IsBoolOp(e Expr) bool {
	...
	case AndOp, AnyOp, AnyScalarOp, BBoxCoversOp,
		...
		SimilarToOp, TSMatchesOp, TrueOp:
		return true
	}
	return false
}
...
func IsComparisonOp(e Expr) bool {
	...
	case BBoxCoversOp, BBoxIntersectsOp, ContainedByOp, ContainsOp,
		...
		NotInOp, NotLikeOp, NotRegIMatchOp, NotRegMatchOp, NotSimilarToOp,
		OverlapsOp, RegIMatchOp, RegMatchOp, SimilarToOp, TSMatchesOp:
		return true
	}
	return false
}
...
func IsAggregateOp(e Expr) bool {
	switch e.Op() {
	case AnyNotNullAggOp, ArrayAggOp, ArrayCatAggOp, AvgOp,
		BitAndAggOp, BitOrAggOp, BoolAndOp, BoolOrOp, ConcatAggOp,
		ConstAggOp, ConstNotNullAggOp, CorrOp, CountOp, CountRowsOp,
		CovarPopOp, CovarSampOp, FirstAggOp, JsonAggOp, JsonObjectAggOp,
		JsonbAggOp, JsonbObjectAggOp, MaxOp, MergeAggregatedStmtMetadataOp, MergeStatementStatsOp,
		MergeStatsMetadataOp, MergeTransactionStatsOp, MinOp, PercentileContOp, PercentileDiscOp,
