...
type AlterFunctionOwner struct {
	logpb.CommonEventDetails `protobuf:"bytes,1,opt,name=common,proto3,embedded=common" json:""`
	CommonSQLEventDetails    `protobuf:"bytes,2,opt,name=sql,proto3,embedded=sql" json:""`
...
func (m *AlterFunctionOwner) Reset()         { *m = AlterFunctionOwner{} }
func (m *AlterFunctionOwner) String() string { return proto.CompactTextString(m) }
func (*AlterFunctionOwner) ProtoMessage()    {}
func (*AlterFunctionOwner) Descriptor() ([]byte, []int) {
	return fileDescriptor_01c4057e16a82528, []int{10}
}
func (m *AlterFunctionOwner) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AlterFunctionOwner) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *AlterFunctionOwner) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AlterFunctionOwner.Merge(m, src)
}
func (m *AlterFunctionOwner) XXX_Size() int {
	return m.Size()
}
func (m *AlterFunctionOwner) XXX_DiscardUnknown() {
	xxx_messageInfo_AlterFunctionOwner.DiscardUnknown(m)
}

var xxx_messageInfo_AlterFunctionOwner proto.InternalMessageInfo
...
func (*AlterDefaultPrivileges) Descriptor() ([]byte, []int) {
	return fileDescriptor_01c4057e16a82528, []int{11}
}
...
func init() {
	...
	proto.RegisterType((*AlterFunctionOwner)(nil), "cockroach.util.log.eventpb.AlterFunctionOwner")
...
var fileDescriptor_01c4057e16a82528 = []byte{
	...
	,
}
...
func (m *AlterFunctionOwner) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AlterFunctionOwner) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AlterFunctionOwner) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.FunctionName) > 0 {
		...
		i = encodeVarintPrivilegeEvents(dAtA, i, uint64(len(m.FunctionName)))
		i--
		dAtA[i] = 0x1a
	}
	{
...
func (m *AlterFunctionOwner) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AlterFunctionOwner) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AlterFunctionOwner: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AlterFunctionOwner: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
