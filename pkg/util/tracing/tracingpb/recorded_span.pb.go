...
func init() {
	...
	proto.RegisterType((*OperationMetadata)(nil), "cockroach.util.tracing.tracingpb.OperationMetadata")
	proto.RegisterType((*RecordedSpan)(nil), "cockroach.util.tracing.tracingpb.RecordedSpan")
	proto.RegisterMapType((map[string]OperationMetadata)(nil), "cockroach.util.tracing.tracingpb.RecordedSpan.ChildrenMetadataEntry")
	proto.RegisterType((*TagGroup)(nil), "cockroach.util.tracing.tracingpb.TagGroup")
	proto.RegisterType((*Tag)(nil), "cockroach.util.tracing.tracingpb.Tag")
	proto.RegisterType((*NormalizedSpan)(nil), "cockroach.util.tracing.tracingpb.NormalizedSpan")
	proto.RegisterMapType((map[string]OperationMetadata)(nil), "cockroach.util.tracing.tracingpb.NormalizedSpan.ChildrenMetadataEntry")
	proto.RegisterMapType((map[string]string)(nil), "cockroach.util.tracing.tracingpb.NormalizedSpan.TagsEntry")
	proto.RegisterType((*CapturedStack)(nil), "cockroach.util.tracing.tracingpb.CapturedStack")
}
