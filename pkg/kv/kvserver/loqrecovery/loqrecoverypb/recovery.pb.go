...
func (m *ReplicaUpdatePlan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.StaleLeaseholderNodeIDs) > 0 {
		dAtA9 := make([]byte, len(m.StaleLeaseholderNodeIDs)*10)
		var j8 int
		...
		i = encodeVarintRecovery(dAtA, i, uint64(j8))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.ClusterID) > 0 {
	...
	if len(m.DecommissionedNodeIDs) > 0 {
		dAtA11 := make([]byte, len(m.DecommissionedNodeIDs)*10)
		var j10 int
		...
		i = encodeVarintRecovery(dAtA, i, uint64(j10))
		i--
		dAtA[i] = 0x1a
	}
	{
...
func (m *NodeRecoveryStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ApplyTimestamp != nil {
		n14, err14 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.ApplyTimestamp, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(*m.ApplyTimestamp):])
		if err14 != nil {
			return 0, err14
		}
		i -= n14
		i = encodeVarintRecovery(dAtA, i, uint64(n14))
		i--
		dAtA[i] = 0x22
	}
...
func (m *PlanApplicationResult) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n15, err15 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.ApplyTimestamp, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.ApplyTimestamp):])
	if err15 != nil {
		return 0, err15
	}
	i -= n15
	i = encodeVarintRecovery(dAtA, i, uint64(n15))
	i--
	dAtA[i] = 0x12
	{
		size := m.AppliedPlanID.Size()
...
func (m *DeferredRecoveryActions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.DecommissionedNodeIDs) > 0 {
		dAtA18 := make([]byte, len(m.DecommissionedNodeIDs)*10)
		var j17 int
		for _, num1 := range m.DecommissionedNodeIDs {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		i = encodeVarintRecovery(dAtA, i, uint64(j17))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
	...
	for iNdEx < l {
		...
		case 5:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.StaleLeaseholderNodeIDs) == 0 {
