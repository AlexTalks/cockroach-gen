...
func (m *FlagPolicy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Operation = &FlagPolicy_SetValue{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			m.Operation = &FlagPolicy_UseDefault{v}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
			...
			m.Operation = &FlagPolicy_DisallowValues{v}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
			...
			m.Operation = &FlagPolicy_AllowValues{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipInvocationPolicy(dAtA[iNdEx:])
...
func (m *DisallowValues) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.ReplacementValue = &DisallowValues_UseDefault{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipInvocationPolicy(dAtA[iNdEx:])
...
func (m *AllowValues) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.ReplacementValue = &AllowValues_UseDefault{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipInvocationPolicy(dAtA[iNdEx:])
