...
func (m *FailureDetail) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 101:
			...
			m.Category = &FailureDetail_Interrupted{v}
			iNdEx = postIndex
		case 103:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_ExternalRepository{v}
			iNdEx = postIndex
		case 104:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_BuildProgress{v}
			iNdEx = postIndex
		case 106:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_RemoteOptions{v}
			iNdEx = postIndex
		case 107:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_ClientEnvironment{v}
			iNdEx = postIndex
		case 108:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_Crash{v}
			iNdEx = postIndex
		case 110:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_SymlinkForest{v}
			iNdEx = postIndex
		case 114:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_PackageOptions{v}
			iNdEx = postIndex
		case 115:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_RemoteExecution{v}
			iNdEx = postIndex
		case 116:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_Execution{v}
			iNdEx = postIndex
		case 117:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_Workspaces{v}
			iNdEx = postIndex
		case 118:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_CrashOptions{v}
			iNdEx = postIndex
		case 119:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_Filesystem{v}
			iNdEx = postIndex
		case 121:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_ExecutionOptions{v}
			iNdEx = postIndex
		case 122:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_Command{v}
			iNdEx = postIndex
		case 123:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_Spawn{v}
			iNdEx = postIndex
		case 124:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_GrpcServer{v}
			iNdEx = postIndex
		case 125:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_CanonicalizeFlags{v}
			iNdEx = postIndex
		case 126:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_BuildConfiguration{v}
			iNdEx = postIndex
		case 127:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_InfoCommand{v}
			iNdEx = postIndex
		case 129:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_MemoryOptions{v}
			iNdEx = postIndex
		case 130:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_Query{v}
			iNdEx = postIndex
		case 132:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_LocalExecution{v}
			iNdEx = postIndex
		case 134:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_ActionCache{v}
			iNdEx = postIndex
		case 135:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_FetchCommand{v}
			iNdEx = postIndex
		case 136:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_SyncCommand{v}
			iNdEx = postIndex
		case 137:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_Sandbox{v}
			iNdEx = postIndex
		case 139:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_IncludeScanning{v}
			iNdEx = postIndex
		case 140:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_TestCommand{v}
			iNdEx = postIndex
		case 141:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_ActionQuery{v}
			iNdEx = postIndex
		case 142:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_TargetPatterns{v}
			iNdEx = postIndex
		case 144:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_CleanCommand{v}
			iNdEx = postIndex
		case 145:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_ConfigCommand{v}
			iNdEx = postIndex
		case 146:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_ConfigurableQuery{v}
			iNdEx = postIndex
		case 147:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_DumpCommand{v}
			iNdEx = postIndex
		case 148:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_HelpCommand{v}
			iNdEx = postIndex
		case 150:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_MobileInstall{v}
			iNdEx = postIndex
		case 151:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_ProfileCommand{v}
			iNdEx = postIndex
		case 152:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_RunCommand{v}
			iNdEx = postIndex
		case 153:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_VersionCommand{v}
			iNdEx = postIndex
		case 154:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_PrintActionCommand{v}
			iNdEx = postIndex
		case 158:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_WorkspaceStatus{v}
			iNdEx = postIndex
		case 159:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_JavaCompile{v}
			iNdEx = postIndex
		case 160:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_ActionRewinding{v}
			iNdEx = postIndex
		case 161:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_CppCompile{v}
			iNdEx = postIndex
		case 162:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_StarlarkAction{v}
			iNdEx = postIndex
		case 163:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_NinjaAction{v}
			iNdEx = postIndex
		case 164:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_DynamicExecution{v}
			iNdEx = postIndex
		case 166:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_FailAction{v}
			iNdEx = postIndex
		case 167:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_SymlinkAction{v}
			iNdEx = postIndex
		case 168:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_CppLink{v}
			iNdEx = postIndex
		case 169:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_LtoAction{v}
			iNdEx = postIndex
		case 172:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_TestAction{v}
			iNdEx = postIndex
		case 173:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_Worker{v}
			iNdEx = postIndex
		case 174:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_Analysis{v}
			iNdEx = postIndex
		case 175:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_PackageLoading{v}
			iNdEx = postIndex
		case 177:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_Toolchain{v}
			iNdEx = postIndex
		case 179:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_StarlarkLoading{v}
			iNdEx = postIndex
		case 181:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_ExternalDeps{v}
			iNdEx = postIndex
		case 182:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_DiffAwareness{v}
			iNdEx = postIndex
		case 183:
			if wireType != 2 {
			...
			m.Category = &FailureDetail_ModqueryCommand{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipFailureDetails(dAtA[iNdEx:])
