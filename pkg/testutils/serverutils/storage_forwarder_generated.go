...
// KVFlowController is part of the interface StorageLayerInterface.
func (f *wrap) KVFlowController() interface{} {
	return f.fwStorageLayerInterface("KVFlowController").KVFlowController()
}

// KVFlowHandles is part of the interface StorageLayerInterface.
func (f *wrap) KVFlowHandles() interface{} {
	return f.fwStorageLayerInterface("KVFlowHandles").KVFlowHandles()
}
