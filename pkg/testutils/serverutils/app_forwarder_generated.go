...
func (f *wrap) RPCClientConn(t TestFataler, userName username.SQLUsername) *grpc.ClientConn {
...
func (f *wrap) RPCClientConnE(userName username.SQLUsername) (*grpc.ClientConn, error) {
...
func (f *wrap) GetAdminClient(t TestFataler) serverpb.AdminClient {
...
func (f *wrap) GetStatusClient(t TestFataler) serverpb.StatusClient {
