...
type MVCCStats struct {
	...
	LockAge int64 `protobuf:"fixed64,2,opt,name=lock_age,json=lockAge" json:"lock_age"`
	...
	// comment above.
	LockBytes int64 `protobuf:"fixed64,21,opt,name=lock_bytes,json=lockBytes" json:"lock_bytes"`
	...
	LockCount int64 `protobuf:"fixed64,16,opt,name=lock_count,json=lockCount" json:"lock_count"`
...
var fileDescriptor_324ef2186f146e22 = []byte{
	...
	,
}
...
func (m *MVCCStats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	i -= 8
	encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(m.LockBytes))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0xa9
	...
	dAtA[i] = 0x89
	i -= 8
	encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(m.LockCount))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0x81
...
func (m *MVCCStats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			...
			m.LockCount = int64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
		case 17:
			if wireType != 1 {
		...
		case 21:
			...
			m.LockBytes = int64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
		default:
			iNdEx = preIndex
			skippy, err := skipMvcc(dAtA[iNdEx:])
