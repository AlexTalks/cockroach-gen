...
type TxnMeta struct {
	...
	IsoLevel isolation.Level `protobuf:"varint,2,opt,name=iso_level,json=isoLevel,proto3,enum=cockroach.kv.kvserver.concurrency.isolation.Level" json:"iso_level,omitempty"`
	...
	CoordinatorNodeID int32 `protobuf:"varint,10,opt,name=coordinator_node_id,json=coordinatorNodeId,proto3" json:"coordinator_node_id,omitempty"`
}
...
type MVCCValueHeader struct {
	...
	KVNemesisSeq github_com_cockroachdb_cockroach_pkg_kv_kvnemesis_kvnemesisutil.Container `protobuf:"bytes,2,opt,name=kvnemesis_seq,json=kvnemesisSeq,proto3,casttype=github.com/cockroachdb/cockroach/pkg/kv/kvnemesis/kvnemesisutil.Container" json:"kvnemesis_seq"`
	...
	// to stale reads.
	LocalTimestamp github_com_cockroachdb_cockroach_pkg_util_hlc.ClockTimestamp `protobuf:"bytes,1,opt,name=local_timestamp,json=localTimestamp,proto3,casttype=github.com/cockroachdb/cockroach/pkg/util/hlc.ClockTimestamp" json:"local_timestamp"`
	...
	OmitInRangefeeds bool `protobuf:"varint,3,opt,name=omit_in_rangefeeds,json=omitInRangefeeds,proto3" json:"omit_in_rangefeeds,omitempty"`
	...
	ImportEpoch uint32 `protobuf:"varint,4,opt,name=import_epoch,json=importEpoch,proto3" json:"import_epoch,omitempty"`
}

func (m *MVCCValueHeader) Reset()         { *m = MVCCValueHeader{} }
func (m *MVCCValueHeader) String() string { return proto.CompactTextString(m) }
func (*MVCCValueHeader) ProtoMessage()    {}
func (*MVCCValueHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_6599d13285d4d9cc, []int{2}
}
func (m *MVCCValueHeader) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MVCCValueHeader) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_MVCCValueHeader.Marshal(b, m, deterministic)
}
func (m *MVCCValueHeader) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MVCCValueHeader.Merge(m, src)
}
func (m *MVCCValueHeader) XXX_Size() int {
	return xxx_messageInfo_MVCCValueHeader.Size(m)
}
func (m *MVCCValueHeader) XXX_DiscardUnknown() {
	xxx_messageInfo_MVCCValueHeader.DiscardUnknown(m)
}

var xxx_messageInfo_MVCCValueHeader proto.InternalMessageInfo

type MVCCValueHeader_Empty struct {
}

func (m *MVCCValueHeader_Empty) Reset()         { *m = MVCCValueHeader_Empty{} }
func (m *MVCCValueHeader_Empty) String() string { return proto.CompactTextString(m) }
func (*MVCCValueHeader_Empty) ProtoMessage()    {}
func (*MVCCValueHeader_Empty) Descriptor() ([]byte, []int) {
	return fileDescriptor_6599d13285d4d9cc, []int{2, 0}
}
func (m *MVCCValueHeader_Empty) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MVCCValueHeader_Empty) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *MVCCValueHeader_Empty) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MVCCValueHeader_Empty.Merge(m, src)
}
func (m *MVCCValueHeader_Empty) XXX_Size() int {
	return m.Size()
}
func (m *MVCCValueHeader_Empty) XXX_DiscardUnknown() {
	xxx_messageInfo_MVCCValueHeader_Empty.DiscardUnknown(m)
}

var xxx_messageInfo_MVCCValueHeader_Empty proto.InternalMessageInfo
...
type MVCCValueHeaderPure struct {
	LocalTimestamp   github_com_cockroachdb_cockroach_pkg_util_hlc.ClockTimestamp `protobuf:"bytes,1,opt,name=local_timestamp,json=localTimestamp,proto3,casttype=github.com/cockroachdb/cockroach/pkg/util/hlc.ClockTimestamp" json:"local_timestamp"`
	OmitInRangefeeds bool                                                         `protobuf:"varint,3,opt,name=omit_in_rangefeeds,json=omitInRangefeeds,proto3" json:"omit_in_rangefeeds,omitempty"`
	ImportEpoch      uint32                                                       `protobuf:"varint,4,opt,name=import_epoch,json=importEpoch,proto3" json:"import_epoch,omitempty"`
}

func (m *MVCCValueHeaderPure) Reset()         { *m = MVCCValueHeaderPure{} }
func (m *MVCCValueHeaderPure) String() string { return proto.CompactTextString(m) }
func (*MVCCValueHeaderPure) ProtoMessage()    {}
func (*MVCCValueHeaderPure) Descriptor() ([]byte, []int) {
	return fileDescriptor_6599d13285d4d9cc, []int{3}
}
func (m *MVCCValueHeaderPure) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MVCCValueHeaderPure) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *MVCCValueHeaderPure) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MVCCValueHeaderPure.Merge(m, src)
}
func (m *MVCCValueHeaderPure) XXX_Size() int {
	return m.Size()
}
func (m *MVCCValueHeaderPure) XXX_DiscardUnknown() {
	xxx_messageInfo_MVCCValueHeaderPure.DiscardUnknown(m)
}

var xxx_messageInfo_MVCCValueHeaderPure proto.InternalMessageInfo

// MVCCValueHeaderCrdbTest is not to be used directly. It's generated only for use of
// its marshaling methods by MVCCValueHeader. See the comment there.
type MVCCValueHeaderCrdbTest struct {
	KVNemesisSeq     github_com_cockroachdb_cockroach_pkg_kv_kvnemesis_kvnemesisutil.Container `protobuf:"bytes,2,opt,name=kvnemesis_seq,json=kvnemesisSeq,proto3,casttype=github.com/cockroachdb/cockroach/pkg/kv/kvnemesis/kvnemesisutil.Container" json:"kvnemesis_seq"`
	LocalTimestamp   github_com_cockroachdb_cockroach_pkg_util_hlc.ClockTimestamp              `protobuf:"bytes,1,opt,name=local_timestamp,json=localTimestamp,proto3,casttype=github.com/cockroachdb/cockroach/pkg/util/hlc.ClockTimestamp" json:"local_timestamp"`
	OmitInRangefeeds bool                                                                      `protobuf:"varint,3,opt,name=omit_in_rangefeeds,json=omitInRangefeeds,proto3" json:"omit_in_rangefeeds,omitempty"`
	ImportEpoch      uint32                                                                    `protobuf:"varint,4,opt,name=import_epoch,json=importEpoch,proto3" json:"import_epoch,omitempty"`
...
func (m *MVCCValueHeaderCrdbTest) Reset()         { *m = MVCCValueHeaderCrdbTest{} }
func (m *MVCCValueHeaderCrdbTest) String() string { return proto.CompactTextString(m) }
func (*MVCCValueHeaderCrdbTest) ProtoMessage()    {}
func (*MVCCValueHeaderCrdbTest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6599d13285d4d9cc, []int{4}
}
func (m *MVCCValueHeaderCrdbTest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MVCCValueHeaderCrdbTest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *MVCCValueHeaderCrdbTest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MVCCValueHeaderCrdbTest.Merge(m, src)
}
func (m *MVCCValueHeaderCrdbTest) XXX_Size() int {
	return m.Size()
}
func (m *MVCCValueHeaderCrdbTest) XXX_DiscardUnknown() {
	xxx_messageInfo_MVCCValueHeaderCrdbTest.DiscardUnknown(m)
}

var xxx_messageInfo_MVCCValueHeaderCrdbTest proto.InternalMessageInfo

type MVCCValueHeaderCrdbTest_Empty struct {
}

func (m *MVCCValueHeaderCrdbTest_Empty) Reset()         { *m = MVCCValueHeaderCrdbTest_Empty{} }
func (m *MVCCValueHeaderCrdbTest_Empty) String() string { return proto.CompactTextString(m) }
func (*MVCCValueHeaderCrdbTest_Empty) ProtoMessage()    {}
func (*MVCCValueHeaderCrdbTest_Empty) Descriptor() ([]byte, []int) {
	return fileDescriptor_6599d13285d4d9cc, []int{4, 0}
}
func (m *MVCCValueHeaderCrdbTest_Empty) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MVCCValueHeaderCrdbTest_Empty) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *MVCCValueHeaderCrdbTest_Empty) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MVCCValueHeaderCrdbTest_Empty.Merge(m, src)
}
func (m *MVCCValueHeaderCrdbTest_Empty) XXX_Size() int {
	return m.Size()
}
func (m *MVCCValueHeaderCrdbTest_Empty) XXX_DiscardUnknown() {
	xxx_messageInfo_MVCCValueHeaderCrdbTest_Empty.DiscardUnknown(m)
}

var xxx_messageInfo_MVCCValueHeaderCrdbTest_Empty proto.InternalMessageInfo
...
type MVCCStatsDelta struct {
	...
	LockBytes         int64 `protobuf:"zigzag64,21,opt,name=lock_bytes,json=lockBytes,proto3" json:"lock_bytes,omitempty"`
	LockCount         int64 `protobuf:"zigzag64,16,opt,name=lock_count,json=lockCount,proto3" json:"lock_count,omitempty"`
	RangeKeyCount     int64 `protobuf:"zigzag64,17,opt,name=range_key_count,json=rangeKeyCount,proto3" json:"range_key_count,omitempty"`
	RangeKeyBytes     int64 `protobuf:"zigzag64,18,opt,name=range_key_bytes,json=rangeKeyBytes,proto3" json:"range_key_bytes,omitempty"`
	RangeValCount     int64 `protobuf:"zigzag64,19,opt,name=range_val_count,json=rangeValCount,proto3" json:"range_val_count,omitempty"`
	RangeValBytes     int64 `protobuf:"zigzag64,20,opt,name=range_val_bytes,json=rangeValBytes,proto3" json:"range_val_bytes,omitempty"`
...
type MVCCWriteValueOp struct {
	...
	OmitInRangefeeds bool `protobuf:"varint,6,opt,name=omit_in_rangefeeds,json=omitInRangefeeds,proto3" json:"omit_in_rangefeeds,omitempty"`
}
...
type MVCCWriteIntentOp struct {
	...
	TxnIsoLevel     isolation.Level                                     `protobuf:"varint,5,opt,name=txn_iso_level,json=txnIsoLevel,proto3,enum=cockroach.kv.kvserver.concurrency.isolation.Level" json:"txn_iso_level,omitempty"`
...
func (m *MVCCDeleteRangeOp) Reset()         { *m = MVCCDeleteRangeOp{} }
func (m *MVCCDeleteRangeOp) String() string { return proto.CompactTextString(m) }
func (*MVCCDeleteRangeOp) ProtoMessage()    {}
func (*MVCCDeleteRangeOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_6599d13285d4d9cc, []int{12}
}
func (m *MVCCDeleteRangeOp) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MVCCDeleteRangeOp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *MVCCDeleteRangeOp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MVCCDeleteRangeOp.Merge(m, src)
}
func (m *MVCCDeleteRangeOp) XXX_Size() int {
	return m.Size()
}
func (m *MVCCDeleteRangeOp) XXX_DiscardUnknown() {
	xxx_messageInfo_MVCCDeleteRangeOp.DiscardUnknown(m)
}

var xxx_messageInfo_MVCCDeleteRangeOp proto.InternalMessageInfo
...
type MVCCLogicalOp struct {
	...
	DeleteRange  *MVCCDeleteRangeOp  `protobuf:"bytes,7,opt,name=delete_range,json=deleteRange,proto3" json:"delete_range,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*MVCCValueHeader)(nil), "cockroach.storage.enginepb.MVCCValueHeader")
	proto.RegisterType((*MVCCValueHeader_Empty)(nil), "cockroach.storage.enginepb.MVCCValueHeader.Empty")
	proto.RegisterType((*MVCCValueHeaderPure)(nil), "cockroach.storage.enginepb.MVCCValueHeaderPure")
	proto.RegisterType((*MVCCValueHeaderCrdbTest)(nil), "cockroach.storage.enginepb.MVCCValueHeaderCrdbTest")
	proto.RegisterType((*MVCCValueHeaderCrdbTest_Empty)(nil), "cockroach.storage.enginepb.MVCCValueHeaderCrdbTest.Empty")
	...
	proto.RegisterType((*MVCCDeleteRangeOp)(nil), "cockroach.storage.enginepb.MVCCDeleteRangeOp")
...
var fileDescriptor_6599d13285d4d9cc = []byte{
	...
	,
}
...
func (this *MVCCValueHeader) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*MVCCValueHeader)
	if !ok {
		that2, ok := that.(MVCCValueHeader)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.KVNemesisSeq.Equal(&that1.KVNemesisSeq) {
		return false
	}
	if !this.LocalTimestamp.Equal(&that1.LocalTimestamp) {
		return false
	}
	if this.OmitInRangefeeds != that1.OmitInRangefeeds {
		return false
	}
...
func (m *TxnMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.CoordinatorNodeID != 0 {
		i = encodeVarintMvcc3(dAtA, i, uint64(m.CoordinatorNodeID))
		i--
		dAtA[i] = 0x50
	}
	{
	...
	if m.IsoLevel != 0 {
		i = encodeVarintMvcc3(dAtA, i, uint64(m.IsoLevel))
		i--
		dAtA[i] = 0x10
	}
	{
...
func (m *MVCCValueHeader_Empty) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MVCCValueHeader_Empty) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MVCCValueHeader_Empty) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MVCCValueHeaderPure) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MVCCValueHeaderPure) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MVCCValueHeaderPure) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.ImportEpoch != 0 {
		i = encodeVarintMvcc3(dAtA, i, uint64(m.ImportEpoch))
		i--
		dAtA[i] = 0x20
	}
...
func (m *MVCCValueHeaderCrdbTest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MVCCValueHeaderCrdbTest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MVCCValueHeaderCrdbTest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MVCCValueHeaderCrdbTest_Empty) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MVCCValueHeaderCrdbTest_Empty) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MVCCValueHeaderCrdbTest_Empty) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MVCCStatsDelta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.LockBytes != 0 {
		i = encodeVarintMvcc3(dAtA, i, uint64((uint64(m.LockBytes)<<1)^uint64((m.LockBytes>>63))))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa8
	...
	if m.RangeValBytes != 0 {
		i = encodeVarintMvcc3(dAtA, i, uint64((uint64(m.RangeValBytes)<<1)^uint64((m.RangeValBytes>>63))))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa0
	...
	if m.RangeValCount != 0 {
		i = encodeVarintMvcc3(dAtA, i, uint64((uint64(m.RangeValCount)<<1)^uint64((m.RangeValCount>>63))))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x98
	...
	if m.RangeKeyBytes != 0 {
		i = encodeVarintMvcc3(dAtA, i, uint64((uint64(m.RangeKeyBytes)<<1)^uint64((m.RangeKeyBytes>>63))))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x90
	...
	if m.RangeKeyCount != 0 {
		i = encodeVarintMvcc3(dAtA, i, uint64((uint64(m.RangeKeyCount)<<1)^uint64((m.RangeKeyCount>>63))))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x88
	...
	if m.LockCount != 0 {
		i = encodeVarintMvcc3(dAtA, i, uint64((uint64(m.LockCount)<<1)^uint64((m.LockCount>>63))))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x80
...
func (m *MVCCWriteIntentOp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.TxnIsoLevel != 0 {
		i = encodeVarintMvcc3(dAtA, i, uint64(m.TxnIsoLevel))
		i--
		dAtA[i] = 0x28
	}
	{
...
func (m *MVCCDeleteRangeOp) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MVCCDeleteRangeOp) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MVCCDeleteRangeOp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func NewPopulatedTxnMeta(r randyMvcc3, easy bool) *TxnMeta {
	...
	this.ID = *v1
	this.IsoLevel = isolation.Level([]int32{0, 1, 2}[r.Intn(3)])
	v2 := r.Intn(100)
	...
	this.CoordinatorNodeID = int32(r.Int31())
	if r.Intn(2) == 0 {
...
func (m *TxnMeta) Size() (n int) {
	...
	if m.IsoLevel != 0 {
		n += 1 + sovMvcc3(uint64(m.IsoLevel))
	}
	l = len(m.Key)
	if l > 0 {
		n += 1 + l + sovMvcc3(uint64(l))
	...
	n += 1 + l + sovMvcc3(uint64(l))
	if m.CoordinatorNodeID != 0 {
		n += 1 + sovMvcc3(uint64(m.CoordinatorNodeID))
	}
	return n
}
...
func (m *MVCCValueHeader_Empty) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MVCCValueHeaderPure) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.ImportEpoch != 0 {
		n += 1 + sovMvcc3(uint64(m.ImportEpoch))
	}
	return n
}

func (m *MVCCValueHeaderCrdbTest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MVCCValueHeaderCrdbTest_Empty) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MVCCStatsDelta) Size() (n int) {
	...
	if m.LockCount != 0 {
		n += 2 + sozMvcc3(uint64(m.LockCount))
	}
	if m.RangeKeyCount != 0 {
		n += 2 + sozMvcc3(uint64(m.RangeKeyCount))
	}
	if m.RangeKeyBytes != 0 {
		n += 2 + sozMvcc3(uint64(m.RangeKeyBytes))
	}
	if m.RangeValCount != 0 {
		n += 2 + sozMvcc3(uint64(m.RangeValCount))
	}
	if m.RangeValBytes != 0 {
		n += 2 + sozMvcc3(uint64(m.RangeValBytes))
	}
	if m.LockBytes != 0 {
		n += 2 + sozMvcc3(uint64(m.LockBytes))
	}
	return n
}
...
func (m *MVCCWriteIntentOp) Size() (n int) {
	...
	n += 1 + l + sovMvcc3(uint64(l))
	if m.TxnIsoLevel != 0 {
		n += 1 + sovMvcc3(uint64(m.TxnIsoLevel))
	}
	return n
}
...
func (m *MVCCDeleteRangeOp) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TxnMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CoordinatorNodeID", wireType)
			}
			m.CoordinatorNodeID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMvcc3
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CoordinatorNodeID |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *MVCCValueHeader) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MVCCValueHeader: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MVCCValueHeader: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
...
func (m *MVCCValueHeader_Empty) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *MVCCValueHeaderPure) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MVCCValueHeaderPure: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MVCCValueHeaderPure: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MVCCValueHeaderCrdbTest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MVCCValueHeaderCrdbTest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MVCCValueHeaderCrdbTest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MVCCValueHeaderCrdbTest_Empty) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *MVCCWriteIntentOp) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxnIsoLevel", wireType)
			}
			m.TxnIsoLevel = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TxnIsoLevel |= isolation.Level(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *MVCCDeleteRangeOp) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MVCCDeleteRangeOp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MVCCDeleteRangeOp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MVCCLogicalOp) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.DeleteRange == nil {
				m.DeleteRange = &MVCCDeleteRangeOp{}
			}
