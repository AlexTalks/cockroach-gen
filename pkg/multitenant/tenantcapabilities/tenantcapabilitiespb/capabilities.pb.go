...
func (*SpanConfigBounds) Descriptor() ([]byte, []int) {
	return fileDescriptor_810c0776c7e5b013, []int{1}
}
...
func (*SpanConfigBounds_Int32Range) Descriptor() ([]byte, []int) {
	return fileDescriptor_810c0776c7e5b013, []int{1, 0}
}
...
func (*SpanConfigBounds_Int64Range) Descriptor() ([]byte, []int) {
	return fileDescriptor_810c0776c7e5b013, []int{1, 1}
}
...
func (*SpanConfigBounds_ConstraintsConjunction) Descriptor() ([]byte, []int) {
	return fileDescriptor_810c0776c7e5b013, []int{1, 2}
}
...
func (*SpanConfigBounds_ConstraintBounds) Descriptor() ([]byte, []int) {
	return fileDescriptor_810c0776c7e5b013, []int{1, 3}
}
...
var fileDescriptor_810c0776c7e5b013 = []byte{
	...
	,
}
